...
const weightInput = document.getElementById('patientWeigth') as HTMLInputElement;
const drugConcentrationInput = document.getElementById('drugConcentration') as HTMLInputElement;
const msdForKilogramInput = document.getElementById('msdForKilogram') as HTMLInputElement;
const cartrigeSizeInput = document.getElementById('cartrigeSize') as HTMLInputElement;
const ageCheckbox = document.getElementById('age') as HTMLInputElement;
const button = document.getElementById('button') as HTMLInputElement;
const resultsOutput = document.getElementById('results') as HTMLInputElement;
...
const attentionElement = document.getElementById('attention') as HTMLInputElement;
const genderAttentionElement = document.getElementById('genderAttention') as HTMLInputElement;
...
function calculate() {
    const kg:number = parseFloat(weightInput.value);
    const msdForKg:number = parseFloat(msdForKilogramInput.value);
    const drugConc:number = parseFloat(drugConcentrationInput.value);
    const vialSize: number = parseFloat(cartrigeSizeInput.value);
